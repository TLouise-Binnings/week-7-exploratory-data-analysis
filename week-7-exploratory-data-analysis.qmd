...
author: Theresa Binnings (and Judith Canner)
format: html
...
**NOTE** The `group_by()` function is never used alone. It is always used before either `summarize()` or `mutate()` to communicate to those functions how to perform their calculations.  
...
```
```{r}
#| label: summarize-city-pollution-size
